...
<!-- docspress:block
{
  ...
  "attrs": {
    ...
    "highlightedLines": "3-4,9-11",
    "showLineNumbers": true,
    "caption": "Manifest source paths resolve relative to the manifest file."
  }
}
-->
**docs/manifest.json — Manifest source paths resolve relative to the manifest file.**
...
<!-- docspress:block
{
  ...
  "attrs": {
    "language": "json",
    "filename": "docs/redirects.json",
    "code": "{\n  \"redirects\": {\n    \"old-start\": \"guides/getting-started\",\n    \"legacy/api\": \"https://developer.wordpress.org/rest-api/\"\n  }\n}",
    "highlightedLines": "3-4",
    "showLineNumbers": true,
    "caption": "Relative targets remain under root-slug; absolute URLs remain external."
  }
}
-->
**docs/redirects.json — Relative targets remain under root-slug; absolute URLs remain external.**
...
<!-- docspress:block
{
  ...
  "attrs": {
    "tone": "note",
    "title": "Not an HTTP redirect",
    "content": "\u003cp\u003eThe moved-page placeholder is a WordPress Page with a destination link. It is not a server-level 301 response.\u003c/p\u003e",
    "collapsible": false
  }
}
-->
...
>
> The moved-page placeholder is a WordPress Page with a destination link. It is not a server-level 301 response.
<!-- /docspress:block -->
